...
def main(flag):
    if flag == 'clo':
        ...
        meta_path = '../data/meta_Toys_and_Games.json'
        save_path = '../data/bundle_toy.pkl'
    else:
        assert False
    random.seed(1234)
    np.random.seed(1234)
    ...
    with open(save_path, 'wb') as f:
        ...
        pickle.dump((user_count, item_count, cate_count, bundle_count, bundle_max_len, example_count), f,
